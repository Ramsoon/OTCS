...
if(isset($_POST['btn_sub'])){
	...
	$sql_add=mysqli_query($db,"INSERT INTO article_tbl 
							VALUES(
								NULL,
								$lid,
								'$title',
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($db,"UPDATE  article_tbl SET	
							loca_id='$loca_id' ,
							title='$title' ,
							content='$content' ,
							status='$status' ,
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($db,"SELECT * FROM article_tbl WHERE a_id=$id");
                ...
                <tr>
                    ...
                    <td>	
                        <select name="sudenttxt" id="textbox">
                                <?php
                                   $location=mysqli_query($db,"SELECT * FROM location_tb");
